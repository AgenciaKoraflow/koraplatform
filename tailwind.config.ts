  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        xl: ['16px', { lineHeight: '1.7', letterSpacing: '0px' }],
        '2xl': ['18px', { lineHeight: '1.7', letterSpacing: '0px' }],
        '3xl': ['20px', { lineHeight: '1.8', letterSpacing: '-0.5px' }],
        '4xl': ['24px', { lineHeight: '1.8', letterSpacing: '-0.5px' }],
      },
      colors: {
      ...
      animation: {
        ...
        "page-enter": "page-enter 0.18s cubic-bezier(0.25,0.46,0.45,0.94) both",
      },
    },
  },
